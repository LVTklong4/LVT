                  ...
                  {selectedBooking && (selectedBooking.type === 'รายวัน' || selectedBooking.type === 'ประจำ') && isAlreadyPaid && (
                    <div className="mt-2.5 border-t border-[#8B4513]/10 pt-3.5 flex flex-col gap-2">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                        ...
                        <button
                          type="button"
                          onClick={() => setShowMoveLockModal(true)}
                        ...
                        <button
                          ...
                          className="px-3 py-2 bg-gradient-to-br from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 border border-emerald-600/10 cursor-pointer"
                        >
                          <Printer className="w-4 h-4 shrink-0" /> พิมพ์ตั๋ว
                        </button>
                      </div>
                    </div>
                  )}
